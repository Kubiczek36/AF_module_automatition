...
\PY{n}{fig}\PY{p}{,} \PY{n}{axs} \PY{o}{=} \PY{n}{pplt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nrows}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{share}\PY{o}{=}\PY{k+kc}{False}\PY{p}{,}
                         \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Testovací obrazce}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{axs}\PY{p}{[}\PY{n}{i}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{o}{\PYZhy{}}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{image}\PY{p}{,} \PY{n}{cmap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Greys}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{axs}\PY{p}{[}\PY{n}{i}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{o}{\PYZhy{}}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{title}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{Delta z = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ }\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{,}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{mu m\PYZdl{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{fig}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{333}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fig}\PY{p}{,} \PY{n}{axs} \PY{o}{=} \PY{n}{pplt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nrows}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{share}\PY{o}{=}\PY{k+kc}{False}\PY{p}{,}
                         \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Využití vepisování kruhů}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{angles} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}

\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
    \PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}imgs/}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.tiff}\PY{l+s+s2}{\PYZdq{}}
    \PY{n}{image} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{readImage}\PY{p}{(}\PY{n}{path}\PY{o}{=}\PY{n}{filename}\PY{p}{)}
    \PY{n}{image} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{threshold}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{intensity}\PY{o}{=}\PY{l+m+mf}{0.4}\PY{p}{)}
    \PY{n}{cx}\PY{p}{,} \PY{n}{cy}\PY{p}{,} \PY{n}{rad} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{findCircles}\PY{p}{(}\PY{n}{image}\PY{p}{)}
    \PY{n}{imC} \PY{o}{=} \PY{n}{gray2rgb}\PY{p}{(}\PY{n}{image}\PY{p}{)}
    \PY{k}{for} \PY{n}{cx}\PY{p}{,} \PY{n}{cy} \PY{o+ow}{in} \PY{n+nb}{zip}\PY{p}{(}\PY{n}{cx}\PY{p}{,} \PY{n}{cy}\PY{p}{)}\PY{p}{:}
        \PY{n}{imC}\PY{p}{[}\PY{n}{cy}\PY{p}{,} \PY{n}{cx}\PY{p}{]} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{1.}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}  \PY{c+c1}{\PYZsh{} zvžraznění středů}
    \PY{n}{axs}\PY{p}{[}\PY{n}{i}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{o}{\PYZhy{}}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{imC}\PY{p}{)}
    \PY{n}{axs}\PY{p}{[}\PY{n}{i}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{o}{\PYZhy{}}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{title}\PY{o}{=}\PY{n+nb}{str}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{ um}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{fig}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{vysl\PYZus{}circ.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{333}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{fig}\PY{p}{,} \PY{n}{axs} \PY{o}{=} \PY{n}{pplt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nrows}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{ncols}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{share}\PY{o}{=}\PY{k+kc}{False}\PY{p}{,}
                         \PY{n}{suptitle}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Využití těžišť}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{angles} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
\PY{n}{defocus} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}

\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{)}\PY{p}{:}
    \PY{n}{defocus}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{i}
    \PY{n}{filename} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{test\PYZus{}imgs/}\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PY{n+nb}{str}\PY{p}{(}\PY{n}{i}\PY{p}{)} \PY{o}{+} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{.tiff}\PY{l+s+s2}{\PYZdq{}}
    \PY{n}{image} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{readImage}\PY{p}{(}\PY{n}{path}\PY{o}{=}\PY{n}{filename}\PY{p}{)}
    \PY{n}{image} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{threshold}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{intensity}\PY{o}{=}\PY{l+m+mf}{0.4}\PY{p}{)}
    \PY{n}{c1}\PY{p}{,} \PY{n}{c2}\PY{p}{,} \PY{n}{angles}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,} \PY{n}{imC} \PY{o}{=} \PY{n}{PSFrot}\PY{o}{.}\PY{n}{centresOfMases}\PY{p}{(}
        \PY{n}{image}\PY{p}{,} \PY{n}{labeledImage}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,} \PY{n}{darkBlobs}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
    \PY{n}{axs}\PY{p}{[}\PY{n}{i}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{4}\PY{o}{\PYZhy{}}\PY{n}{i} \PY{o}{\PYZpc{}} \PY{l+m+mi}{5}\PY{p}{]}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{imC}\PY{p}{)}
    \PY{n}{axisTitle} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{\PYZdl{}}\PY{l+s+s2}{\PYZbs{}}\PY{l+s+s2}{Delta z = }\PY{l+s+s2}{\PYZdq{}} \PY{o}{+} \PYZbs{}
